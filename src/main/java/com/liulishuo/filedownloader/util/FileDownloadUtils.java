...
//                .getExternalStorageDirectory().toString());
    ...
    public static String defaultUserAgent() {
        return formatString("FileDownloader/%s", "1.8.0");
    }
    ...
    public static boolean canStartForgroundService(Context context) {
        return Build.VERSION.SDK_INT < 31 || isAppOnForeground(context);
    }
